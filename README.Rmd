...
**ignore_sample_size** | | |
**voom** | | | If **voom** is provided then both **norm_factors_method** and **voom_normalize_method** must be provided
**norm_factors_method** |  | | TMM, TMMwsp, RLE, upperquartile, none. See [edgeR::calcNormFactors](https://bioconductor.org/packages/release/bioc/html/edgeR.html) for documentation (v. 3.26.5).
